...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_0__["default"])(".balcon_icons", ".balcon_icons_img", ".big_img > img", "do_image_more", "inline");
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_2__["showModalByTime"])(".popup", 5000);
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_2__["default"])(".popup_engineer", ".popup_engineer_btn", "[data-modal]");
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_2__["default"])(".popup", ".phone_link", "[data-modal]");
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_2__["default"])(".popup_calc", ".glazing_price_btn", "[data-modal]", false);
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_2__["default"])(".popup_calc_profile", ".popup_calc_button", "[data-modal]", false);
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_2__["default"])(".popup_calc_end", ".popup_calc_profile_button", "[data-modal]", false);
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])("form", "[data-modal]", "input[name='user_phone']", "input[name='user_name']", modalState);
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])("#timer", "2022-08-11T10:15:00");
});
...
var changeModalState = function changeModalState(state) {
  ...
  var saveChangeModalState = function saveChangeModalState(event, elements, prop) {
        ...
        switch (element.nodeName) {
          ...
          case 'INPUT':
            if (element.getAttribute("type") == "checkbox") {
              ...
              elements.forEach(function (item, j) {
                item.checked = false;
...
/***/ "./src/js/modules/checkAllModalData.js":
/*!*********************************************!*\
  !*** ./src/js/modules/checkAllModalData.js ***!
  \*********************************************/
/*! exports provided: default */
...
var checkAllModalData = function checkAllModalData(btn) {
  var windowWidth = document.querySelector("#width"),
      windowHeight = document.querySelector("#height"),
      windowProfile = document.querySelectorAll(".checkbox");
  var modalOne = btn.classList.contains('popup_calc_button'),
  ...
  if (windowWidth.value != "" && windowHeight.value != "" && modalOne) {
    ...
    try {
      for (var _iterator = windowProfile[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
/* harmony default export */ __webpack_exports__["default"] = (checkAllModalData);
...
var checkNameInput = function checkNameInput(selector) {
  var nameInputs = document.querySelectorAll(selector);
...
/* harmony import */ var _checkNameInput__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./checkNameInput */ "./src/js/modules/checkNameInput.js");
...
var forms = function forms(formSelector, headerSelector, phoneInputsAttribute, nameInputsAttribute, modalState) {
  var forms = document.querySelectorAll(formSelector);
  Object(_checkNumInput__WEBPACK_IMPORTED_MODULE_6__["default"])(phoneInputsAttribute);
  Object(_checkNameInput__WEBPACK_IMPORTED_MODULE_7__["default"])(nameInputsAttribute);
  var message = {
  ...
  var bindPostData = function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      var statusMessage = function statusMessage(tag, message) {
      ...
      var dynamicStatusMessage = function dynamicStatusMessage(tagStatusMessage, message) {
        ...
        setTimeout(function () {
          Object(_modals__WEBPACK_IMPORTED_MODULE_5__["closeAllModal"])(headerSelector);
          form.firstElementChild.remove();
      ...
      if (form.getAttribute("data-calc") === "end") {
        //если у формы есть атрибут ..., то добавим ещё данных
      ...
      Object(_services_services__WEBPACK_IMPORTED_MODULE_4__["default"])('assets/server.php', formData).then(function (data) {
        console.log(data);
...
/*!**********************************!*\
  !*** ./src/js/modules/modals.js ***!
  \**********************************/
/*! exports provided: default, closeAllModal, showModalByTime */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _checkAllModalData__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checkAllModalData */ "./src/js/modules/checkAllModalData.js");
...
var closeAllModal = function closeAllModal(modalSelector) {
  var windows = document.querySelectorAll(modalSelector);
...
var modal = function modal(modalSelector, triggerSelector, modalHeader) {
  ...
  triggers.forEach(function (trigger) {
    trigger.addEventListener('click', function (e) {
      ...
      if (Object(_checkAllModalData__WEBPACK_IMPORTED_MODULE_1__["default"])(e.target)) {
